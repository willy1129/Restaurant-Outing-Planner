/**
    WARNING - DEPRECATED: Please use eventController.js instead
*/
...
//   try {
//     const { id } = req.params;
//     const [result] = await db.execute("DELETE FROM events WHERE event_id = ?", [
//       id,
//     ]);
...
//     const [rows] = await db.execute("SELECT * FROM events WHERE host_id = ?", [
//       uid,
//     ]);
//     res.send(rows);
//   } catch (err) {
