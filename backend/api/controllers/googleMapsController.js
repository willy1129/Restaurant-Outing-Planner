...
exports.getPlaceDetails = async (req, res) => {
  try {
    ...
    /**
     * Refer to 'https://developers.google.com/maps/documentation/places/web-service/details' for more information on fields
     * geometry: { location: { lat, lng}, viewport: { type: Bounds }}
     */
